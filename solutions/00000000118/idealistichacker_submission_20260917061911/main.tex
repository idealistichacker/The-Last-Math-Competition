...
This PDF was compiled locally with cached-only Tectonic~0.15.0. An internal
independent-AI review has been recorded, and the package is submitted for upstream
review in PR~\#103. It makes no claim of organizer approval, merge, acceptance,
rank, award, or human verification. Future substantive changes require fresh
independent review and release-coordinator validation before a normal update to
that same review request.
\end{document}
